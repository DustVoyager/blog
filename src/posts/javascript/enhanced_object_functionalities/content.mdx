---
title: "Javascript enhanced object functionalities"
desc: javascript enhanced object functionalities 대해서 정리한 글입니다.
date: 2024-10-12
...
const convertExtension = function (fullFileName) {
  ...
  const ext =
    fullFileNameArr[1] && fullFileNameArr[1] === "png" ? "jpg" : "gif";
  return {
    filename,
    ext,
  };
